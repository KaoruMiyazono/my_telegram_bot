...
class Settings(BaseSettings):
    ...
    PROACTIVE_COLD_START_THRESHOLD: float = 0.9
    PROACTIVE_INTEREST_MAX_ITEMS: int = 24
    PROACTIVE_INTEREST_MAX_CHARS: int = 6000
    PROACTIVE_LLM_JUDGE_ENABLED: bool = False
    PROACTIVE_CONTENT_DEDUPE_HOURS: int = 168
    PROACTIVE_SEMANTIC_DEDUPE_HOURS: int = 24
    PROACTIVE_SEMANTIC_SIMILARITY_THRESHOLD: float = 0.88
    PROACTIVE_EMPTY_BACKOFF_MULTIPLIER: float = 2.0
    PROACTIVE_EMPTY_BACKOFF_MAX_SECONDS: int = 2400
    PROACTIVE_ERROR_BACKOFF_BASE_SECONDS: int = 60
    PROACTIVE_ERROR_BACKOFF_MAX_SECONDS: int = 1800
    PROACTIVE_ALERT_INTERVAL_SECONDS: int = 60
    PROACTIVE_SCHEDULE_JITTER_RATIO: float = 0.1
    PROACTIVE_ACK_MAX_ATTEMPTS: int = 5
